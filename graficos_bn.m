...
figure(2), subplot(2,1,1), legend('Filtered x_1(SOC)','Predicted x_1(SOC)')
...
figure(2), subplot(2,1,2), plot(soc_counting(1:s_est.tpo_predic),v_estim(1:s_est.tpo_predic)+I(1:s_est.tpo_predic)*s_est.CI(1),'k','Linewidth',2);
figure(2), subplot(2,1,2), plot(soc_counting(s_est.tpo_predic+1:end),s_result.reali(reali_plot).voltage+s_result.reali(reali_plot).Isint'*s_est.CI(1),'color','k','Linewidth',2,'Linestyle','--')
...
figure(3), h3(1) = plot(soc_filtrado(1:s_est.tpo_predic)*100,'k','Linewidth',2);
